...
//=========  (Thu Jun 25 21:44:09 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,2.783327);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.9241027);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3507401);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1174383);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.06322833);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.04229133);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.3135686);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.3873866);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.5969599);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.448064);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,3.484035);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,8.168466);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.0380622);
   Graph_Graph1->SetMaximum(8.981083);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,3.477616);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.235489);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.4759106);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1665547);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.09263768);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06536769);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1901357);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.2456325);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.3966464);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.014407);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,2.511424);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,6.191147);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.05883092);
   Graph_Graph2->SetMaximum(6.803724);
   ...
   grae->SetPoint(0,800,4.596979);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.745906);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.6880418);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.2526404);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.1478215);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.1101942);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.09917478);
   Graph_Graph3->SetMaximum(5.045658);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow e#nu LP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
