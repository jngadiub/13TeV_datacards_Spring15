...
//=========  (Thu Jun 25 21:42:58 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,0.6855809);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.2541732);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.08754329);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.03023464);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.01706889);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.0127433);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1177413);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1377668);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.183357);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.380921);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.9580744);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,2.159719);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.01146897);
   Graph_Graph1->SetMaximum(2.374417);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.8725429);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.3411724);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1202848);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.04461367);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02690961);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02130521);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.0725842);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.08221372);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.11633);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.2633531);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.6939712);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.618524);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.01917469);
   Graph_Graph2->SetMaximum(1.778246);
   ...
   grae->SetPoint(0,800,1.173971);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.4837794);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1757732);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.07068555);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.04636219);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.03883674);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.03495306);
   Graph_Graph3->SetMaximum(1.287485);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow e#nu HP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
