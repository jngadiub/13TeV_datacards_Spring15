...
//=========  (Thu Jun 25 21:32:25 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,1.62229);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.6582676);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.268653);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1060892);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.0602677);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.04134592);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.3197794);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.3829285);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.5522874);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.126722);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,2.427122);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,5.09454);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.03721133);
   Graph_Graph1->SetMaximum(5.599859);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,2.064699);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.8732237);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3660388);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1505405);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.08921131);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06437822);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1917603);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.2407751);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.3647319);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.7872292);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,1.75806);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,3.807768);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.0579404);
   Graph_Graph2->SetMaximum(4.182107);
   ...
   grae->SetPoint(0,800,2.777969);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.225575);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.5310823);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.2311391);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.1435212);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.1091191);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.09820722);
   Graph_Graph3->SetMaximum(3.044854);
