...
//=========  (Thu Jun 25 21:36:42 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",72,206,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   grae->SetPoint(0,800,0.2224718);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1040713);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.04155683);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.01677943);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.01034702);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.007797393);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.0604269);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.06763015);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.08655018);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.1632275);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.3508562);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.6729488);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.007017653);
   Graph_Graph1->SetMaximum(0.739464);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.2802723);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1353046);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.05596893);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.02385245);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.0155621);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01230711);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.03668679);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.04252402);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.05705594);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.116018);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.2589252);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.5089262);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.0110764);
   Graph_Graph2->SetMaximum(0.5585881);
   ...
   grae->SetPoint(0,800,0.3734608);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1856603);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.07998909);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.03624924);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02534771);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02106736);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.01896063);
   Graph_Graph3->SetMaximum(0.4087001);
