...
//=========  (Thu Jun 25 22:09:18 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,0.7190209);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.2336551);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.09550464);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.04134263);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02669741);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01831133);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1074699);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1376058);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1894121);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.3746376);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.8398042);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.953906);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.0164802);
   Graph_Graph1->SetMaximum(2.147465);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.8773956);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.3103133);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1287102);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.05754723);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.03795114);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02662734);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.06882873);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.09055066);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1293994);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.2670904);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.61264);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.50749);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.0239646);
   Graph_Graph2->SetMaximum(1.655576);
   ...
   grae->SetPoint(0,800,1.132734);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.4318823);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.18314);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.08500975);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.05767543);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.04223153);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.03800838);
   Graph_Graph3->SetMaximum(1.241785);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow #mu#nu (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
