...
//=========  (Thu Jun 25 20:36:52 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,1.806148);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.7522492);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.2976324);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.117796);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.06442038);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.0434493);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.3214492);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.3834867);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.5696972);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.167528);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,2.578689);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,5.160019);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.03910437);
   Graph_Graph1->SetMaximum(5.671675);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,2.238557);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.9816151);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.4011148);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1651678);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.09391034);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06676986);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1951604);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.2444292);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.3817537);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.8323654);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,1.895473);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,3.930364);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.06009288);
   Graph_Graph2->SetMaximum(4.316723);
   ...
   grae->SetPoint(0,800,2.935707);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.351409);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.5707407);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.2481957);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.1492454);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.1120707);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.1008637);
   Graph_Graph3->SetMaximum(3.21807);
