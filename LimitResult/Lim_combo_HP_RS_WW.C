...
//=========  (Thu Jun 25 21:48:31 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",46,98,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   hframe__1->GetYaxis()->SetTitle("#sigma_{95%} #times BR(G_{RS} #rightarrow WW)(pb)");
   ...
   grae->SetPoint(0,800,0.5367161);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1719435);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.06413423);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.02353959);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.01363344);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.009781863);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.07312001);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.08588211);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1176132);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.2500274);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.6122402);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.471424);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.008803677);
   Graph_Graph1->SetMaximum(1.617588);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.658969);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.2272156);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.0862589);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.03330761);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02028689);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01525365);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.04465966);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.05445577);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.07836799);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.1777132);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.4482996);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.13247);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.01372829);
   Graph_Graph2->SetMaximum(1.244191);
   ...
   grae->SetPoint(0,800,0.8560706);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.3178162);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1225251);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.05042791);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.03277145);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02588276);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.02329448);
   Graph_Graph3->SetMaximum(0.9390893);
   ...
   graph->SetPoint(0,800,1.16691);
   graph->SetPoint(1,1000,0.377865);
   graph->SetPoint(2,1400,0.0616708);
   graph->SetPoint(3,2000,0.00751431);
   graph->SetPoint(4,2500,0.00167726);
   graph->SetPoint(5,3000,0.000443483);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.0003991347);
   Graph_Graph1->SetMaximum(1.283557);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   Graph_Graph1->SetLineStyle(0);
   Graph_Graph1->SetMarkerStyle(20);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("Graph3","G_{RS}","L");
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow l#nu HP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
...
tex->SetNDC();
   ...
   hframe__2->GetYaxis()->SetTitle("#sigma_{95%} #times BR(G_{RS} #rightarrow WW)(pb)");
   ...
   hframe__3->GetYaxis()->SetTitle("#sigma_{95%} #times BR(G_{RS} #rightarrow WW)(pb)");
