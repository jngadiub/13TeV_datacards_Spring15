...
//=========  (Thu Jun 25 21:41:04 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",-15,138,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   grae->SetPoint(0,800,0.2346482);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1049136);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.04090109);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.01617176);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.009689184);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.00698405);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.04903302);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.05871765);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.07965753);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.1578929);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.3464599);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.6789932);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.006285645);
   Graph_Graph1->SetMaximum(0.7461941);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.2927031);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1354148);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.05490085);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.02288242);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.01444699);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01078738);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.03035554);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.03760552);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.05356283);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.1129139);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.2574329);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.5171862);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.009708646);
   Graph_Graph2->SetMaximum(0.5678261);
   ...
   grae->SetPoint(0,800,0.3863018);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1845902);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.07784892);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.03464411);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02307378);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01792398);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.01613158);
   Graph_Graph3->SetMaximum(0.4231396);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow l#nu (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
