...
//=========  (Thu Jun 25 22:11:25 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,0.6785917);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.232645);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.09931649);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.04486406);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.03093103);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02330091);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1466115);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1709728);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.2166707);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.3982135);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.8602577);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.944856);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.02097082);
   Graph_Graph1->SetMaximum(2.137012);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.8423979);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.3110373);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1336688);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.06262585);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.04451875);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.03449119);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.09220461);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1116072);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1449562);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.2813767);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.6234969);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,1.481389);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.03104207);
   Graph_Graph2->SetMaximum(1.626078);
   ...
   grae->SetPoint(0,800,1.106493);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.4395359);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.191887);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.09375674);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.06915584);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.05548868);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.04993981);
   Graph_Graph3->SetMaximum(1.211594);
