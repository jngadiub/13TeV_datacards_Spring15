...
//=========  (Thu Jun 25 21:38:09 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",355,143,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   grae->SetPoint(0,800,0.2860067);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.1480645);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.06511549);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.03203722);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.02348376);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.01875578);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1233683);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1359894);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1605736);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.2636255);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.5145764);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.9131959);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.0168802);
   Graph_Graph1->SetMaximum(1.00264);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.3665446);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.19393);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.08781496);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.04512452);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.03413177);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02805762);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.07635159);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.08709396);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.1063158);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.1851795);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,0.3757208);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,0.6843619);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.02525186);
   Graph_Graph2->SetMaximum(0.7499923);
   ...
   grae->SetPoint(0,800,0.4963913);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.2678764);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.1262846);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.06806247);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.05343861);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.04551165);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.000423682);
   Graph_Graph3->SetMaximum(0.5414793);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow #mu#nu HP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
