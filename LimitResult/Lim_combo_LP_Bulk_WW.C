...
//=========  (Thu Jun 25 21:39:38 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",523,140,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   grae->SetPoint(0,800,1.323005);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.5062604);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.195406);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.07363858);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.03936597);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02541721);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1719815);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.2170382);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.3391731);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.7422864);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,1.695143);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,3.640005);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.02287549);
   Graph_Graph1->SetMaximum(4.001464);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,1.624359);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.6581964);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.2612502);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1025018);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.05665909);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.03829081);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1064709);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1406394);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.2304834);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.5325246);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,1.259556);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,2.80836);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.03446173);
   Graph_Graph2->SetMaximum(3.085367);
   ...
   grae->SetPoint(0,800,2.110214);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.9031544);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3691804);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1514175);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.08801476);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06286768);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.05658091);
   Graph_Graph3->SetMaximum(2.314949);
