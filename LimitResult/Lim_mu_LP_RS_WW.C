...
//=========  (Thu Jun 25 21:39:38 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,2.836312);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.024747);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3601383);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1292294);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.06750831);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.04064112);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.2829128);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.3866398);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.6167202);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.418032);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,3.464925);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,7.75527);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.03657701);
   Graph_Graph1->SetMaximum(8.526733);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,3.497574);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.332288);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.4863369);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1814919);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.09811793);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06190639);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1752317);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.247918);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.4153884);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,1.010957);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,2.564103);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,5.983397);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.05571575);
   Graph_Graph2->SetMaximum(6.575546);
   ...
   grae->SetPoint(0,800,4.49595);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.82812);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.6931985);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.2700631);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.1536189);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.1025037);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.09225335);
   Graph_Graph3->SetMaximum(4.935294);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow #mu#nu LP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
