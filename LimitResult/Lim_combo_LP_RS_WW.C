...
//=========  (Thu Jun 25 21:48:34 2015) by ROOT version5.34/18
   TCanvas *c2 = new TCanvas("c2", "c2",369,135,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   grae->SetPoint(0,800,2.220433);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.6981072);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.2458151);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.08209896);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.041758);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.02526359);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1620269);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.2216647);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.3684316);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.9337748);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,2.353919);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,5.750907);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,580,3220);
   Graph_Graph1->SetMinimum(0.02273723);
   Graph_Graph1->SetMaximum(6.323472);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,2.681282);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,0.9109648);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3294992);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1131122);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.05953217);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.03759284);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,3000,0.1018781);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,2500,0.1455267);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,2000,0.2535812);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1400,0.6699005);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1000,1.749051);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,800,4.475281);
   grae->SetPointError(11,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,580,3220);
   Graph_Graph2->SetMinimum(0.03383356);
   Graph_Graph2->SetMaximum(4.91905);
   ...
   grae->SetPoint(0,800,3.424282);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1000,1.254143);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.4644183);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,2000,0.1674688);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,2500,0.09176006);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,3000,0.06072751);
   grae->SetPointError(5,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,580,3220);
   Graph_Graph3->SetMinimum(0.05465476);
   Graph_Graph3->SetMaximum(3.760638);
   ...
   entry->SetTextFont(62);
   leg->Draw();
   TLatex *   tex = new TLatex(0.96,0.936,"1 fb^{-1},W#rightarrow l#nu LP (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
