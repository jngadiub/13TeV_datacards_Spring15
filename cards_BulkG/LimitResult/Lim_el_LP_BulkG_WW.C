...
//=========  (Tue Jan 26 14:46:02 2016) by ROOT version5.34/18
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,0.8,8.132932);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.9,4.916432);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1,3.455922);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1.1,2.572316);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1.2,1.984532);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.3,1.533182);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.4,1.222827);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.5,0.9801147);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.6,0.8244755);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.7,0.6806979);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.8,0.5689635);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.9,0.5199285);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,2,0.48576);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2.1,0.4109088);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2.2,0.3500653);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2.3,0.3021158);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2.4,0.2620938);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,2.5,0.2295466);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,2.6,0.2105934);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,2.7,0.1958676);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,2.8,0.1831053);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,2.9,0.1734515);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,3,0.1648126);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,3.1,0.1551988);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,3.2,0.1476754);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,3.3,0.1419479);
   grae->SetPointError(25,0,0,0,0);
   grae->SetPoint(26,3.4,0.1371228);
   grae->SetPointError(26,0,0,0,0);
   grae->SetPoint(27,3.5,0.1334884);
   grae->SetPointError(27,0,0,0,0);
   grae->SetPoint(28,3.6,0.13106);
   grae->SetPointError(28,0,0,0,0);
   grae->SetPoint(29,3.7,0.1301887);
   grae->SetPointError(29,0,0,0,0);
   grae->SetPoint(30,3.8,0.1291713);
   grae->SetPointError(30,0,0,0,0);
   grae->SetPoint(31,3.9,0.1285462);
   grae->SetPointError(31,0,0,0,0);
   grae->SetPoint(32,4,0.1288364);
   grae->SetPointError(32,0,0,0,0);
   grae->SetPoint(33,4,0.6269506);
   grae->SetPointError(33,0,0,0,0);
   grae->SetPoint(34,3.9,0.6211723);
   grae->SetPointError(34,0,0,0,0);
   grae->SetPoint(35,3.8,0.6153939);
   grae->SetPointError(35,0,0,0,0);
   grae->SetPoint(36,3.7,0.6096156);
   grae->SetPointError(36,0,0,0,0);
   grae->SetPoint(37,3.6,0.6096156);
   grae->SetPointError(37,0,0,0,0);
   grae->SetPoint(38,3.5,0.6096156);
   grae->SetPointError(38,0,0,0,0);
   grae->SetPoint(39,3.4,0.6211723);
   grae->SetPointError(39,0,0,0,0);
   grae->SetPoint(40,3.3,0.632729);
   grae->SetPointError(40,0,0,0,0);
   grae->SetPoint(41,3.2,0.650064);
   grae->SetPointError(41,0,0,0,0);
   grae->SetPoint(42,3.1,0.6789558);
   grae->SetPointError(42,0,0,0,0);
   grae->SetPoint(43,3,0.7078475);
   grae->SetPointError(43,0,0,0,0);
   grae->SetPoint(44,2.9,0.73385);
   grae->SetPointError(44,0,0,0,0);
   grae->SetPoint(45,2.8,0.7656309);
   grae->SetPointError(45,0,0,0,0);
   grae->SetPoint(46,2.7,0.8060794);
   grae->SetPointError(46,0,0,0,0);
   grae->SetPoint(47,2.6,0.8580845);
   grae->SetPointError(47,0,0,0,0);
   grae->SetPoint(48,2.5,0.9274247);
   grae->SetPointError(48,0,0,0,0);
   grae->SetPoint(49,2.4,1.042992);
   grae->SetPointError(49,0,0,0,0);
   grae->SetPoint(50,2.3,1.184561);
   grae->SetPointError(50,0,0,0,0);
   grae->SetPoint(51,2.2,1.357912);
   grae->SetPointError(51,0,0,0,0);
   grae->SetPoint(52,2.1,1.577489);
   grae->SetPointError(52,0,0,0,0);
   grae->SetPoint(53,2,1.854849);
   grae->SetPointError(53,0,0,0,0);
   grae->SetPoint(54,1.9,1.970416);
   grae->SetPointError(54,0,0,0,0);
   grae->SetPoint(55,1.8,2.16688);
   grae->SetPointError(55,0,0,0,0);
   grae->SetPoint(56,1.7,2.554029);
   grae->SetPointError(56,0,0,0,0);
   grae->SetPoint(57,1.6,3.085637);
   grae->SetPointError(57,0,0,0,0);
   grae->SetPoint(58,1.5,3.663472);
   grae->SetPointError(58,0,0,0,0);
   grae->SetPoint(59,1.4,4.564894);
   grae->SetPointError(59,0,0,0,0);
   grae->SetPoint(60,1.3,5.709007);
   grae->SetPointError(60,0,0,0,0);
   grae->SetPoint(61,1.2,7.37317);
   grae->SetPointError(61,0,0,0,0);
   grae->SetPoint(62,1.1,9.476489);
   grae->SetPointError(62,0,0,0,0);
   grae->SetPoint(63,1,12.71236);
   grae->SetPointError(63,0,0,0,0);
   grae->SetPoint(64,0.9,17.73952);
   grae->SetPointError(64,0,0,0,0);
   grae->SetPoint(65,0.8,28.38324);
   grae->SetPointError(65,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.48,4.32);
   Graph_Graph2->SetMinimum(0.1156916);
   Graph_Graph2->SetMaximum(31.20871);
   ...
   grae->SetPoint(0,0.8,14.10379);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.9,8.814868);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1,6.316844);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1.1,4.70892);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1.2,3.663769);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.3,2.836837);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.4,2.268321);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.5,1.8204);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.6,1.53327);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.7,1.269111);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.8,1.076735);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.9,0.9791108);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,2,0.9216849);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2.1,0.7838629);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2.2,0.6747538);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2.3,0.588615);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2.4,0.5182683);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,2.5,0.4608425);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,2.6,0.4263869);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,2.7,0.4005453);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,2.8,0.3804463);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,2.9,0.3646542);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,3,0.3517333);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,3.1,0.3373769);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,3.2,0.3230204);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,3.3,0.3144065);
   grae->SetPointError(25,0,0,0,0);
   grae->SetPoint(26,3.4,0.308664);
   grae->SetPointError(26,0,0,0,0);
   grae->SetPoint(27,3.5,0.3029214);
   grae->SetPointError(27,0,0,0,0);
   grae->SetPoint(28,3.6,0.3029214);
   grae->SetPointError(28,0,0,0,0);
   grae->SetPoint(29,3.7,0.3029214);
   grae->SetPointError(29,0,0,0,0);
   grae->SetPoint(30,3.8,0.3057927);
   grae->SetPointError(30,0,0,0,0);
   grae->SetPoint(31,3.9,0.308664);
   grae->SetPointError(31,0,0,0,0);
   grae->SetPoint(32,4,0.3115352);
   grae->SetPointError(32,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,0.48,4.32);
   Graph_Graph3->SetMinimum(0.2726292);
   Graph_Graph3->SetMaximum(15.48388);
   ...
   grae->SetPoint(0,0.8,8.221625);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.9,3.029299);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1,2.617885);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1.1,3.258925);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1.2,2.47897);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.3,2.769566);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.4,1.849423);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.5,1.209811);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.6,0.800545);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.7,0.5967745);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.8,0.6185467);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.9,0.6096746);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,2,0.5214813);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2.1,0.4218245);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2.2,0.3849136);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2.3,0.3686824);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2.4,0.3676908);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,2.5,0.3829874);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,2.6,0.436617);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,2.7,0.518713);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,2.8,0.5415412);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,2.9,0.4956747);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,3,0.3379975);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,3.1,0.2742949);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,3.2,0.2646343);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,3.3,0.2624488);
   grae->SetPointError(25,0,0,0,0);
   grae->SetPoint(26,3.4,0.2616812);
   grae->SetPointError(26,0,0,0,0);
   grae->SetPoint(27,3.5,0.2617511);
   grae->SetPointError(27,0,0,0,0);
   grae->SetPoint(28,3.6,0.2640011);
   grae->SetPointError(28,0,0,0,0);
   grae->SetPoint(29,3.7,0.2679251);
   grae->SetPointError(29,0,0,0,0);
   grae->SetPoint(30,3.8,0.2723537);
   grae->SetPointError(30,0,0,0,0);
   grae->SetPoint(31,3.9,0.2770819);
   grae->SetPointError(31,0,0,0,0);
   grae->SetPoint(32,4,0.2821975);
   grae->SetPointError(32,0,0,0,0);
   
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0.48,4.32);
   Graph_Graph4->SetMinimum(0.235513);
   Graph_Graph4->SetMaximum(9.017619);
