...
//=========  (Wed Nov 11 09:09:20 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,10.67862);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,3.016459);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,2.054397);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,1.295112);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.9142441);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.6484129);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.4326169);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.2635482);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.2394037);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4500,0.1755786);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,1.708845);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,3500,2.129392);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,3000,2.190644);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2500,3.060074);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2000,3.932279);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,1800,5.166792);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,1600,6.639078);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1400,10.08637);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1200,13.80673);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,800,38.13322);
   grae->SetPointError(19,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,430,4870);
   Graph_Graph1->SetMinimum(0.1580207);
   Graph_Graph1->SetMaximum(41.92899);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,14.03915);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,4.198785);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,2.893625);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,1.833513);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,1.325509);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.9500086);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.6564092);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.4175687);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.3931441);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4500,0.3006287);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,1.071341);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,3500,1.290419);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,3000,1.301529);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2500,1.882705);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2000,2.494816);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,1800,3.34262);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,1600,4.411295);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1400,6.747946);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1200,9.416573);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,800,27.67818);
   grae->SetPointError(19,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,430,4870);
   Graph_Graph2->SetMinimum(0.2705658);
   Graph_Graph2->SetMaximum(30.41593);
   ...
   grae->SetPoint(0,800,19.45714);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,6.202518);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,4.364529);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,2.809735);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,2.071208);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,1.515924);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,1.091132);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.7274215);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.7024337);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4500,0.5636128);
   grae->SetPointError(9,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,430,4870);
   Graph_Graph3->SetMinimum(0.5072516);
   Graph_Graph3->SetMaximum(21.34649);
