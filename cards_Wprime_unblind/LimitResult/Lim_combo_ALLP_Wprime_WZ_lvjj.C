...
//=========  (Tue Nov 24 19:59:38 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,0.1016077);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.01137085);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.009189911);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.00810318);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.00702919);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.006347427);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.004101753);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.002480507);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.001552505);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.001100292);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.0009216881);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,0.00744057);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,0.008033066);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,0.009119467);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,0.01173167);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,0.01625929);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,0.02476953);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,0.02878538);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,0.03599593);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,0.04524826);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,0.06114095);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,0.2872538);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","Graph",100,430,4870);
   Graph_Graph5->SetMinimum(0.0008295193);
   Graph_Graph5->SetMaximum(0.315887);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,0.1232432);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.01715333);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.01340441);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.01139728);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.009537736);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.008442162);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.00538594);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.003369165);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.002224811);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.001678857);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.001436009);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,0.004420672);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,0.004836006);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,0.005737586);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,0.007739947);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,0.01125911);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,0.01739374);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,0.02021983);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,0.02516601);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,0.03119397);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,0.04188677);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,0.2129605);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Graph",100,430,4870);
   Graph_Graph6->SetMinimum(0.001292408);
   Graph_Graph6->SetMaximum(0.2341129);
   ...
   grae->SetPoint(0,800,0.158125);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.02695313);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.02054687);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.01679687);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.01378906);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.01199219);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.007636719);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.004980469);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.003486328);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.002802734);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.002470703);
   grae->SetPointError(10,0,0,0,0);
   
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","Graph",100,430,4870);
   Graph_Graph7->SetMinimum(0.002223633);
   Graph_Graph7->SetMaximum(0.1736904);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph3","#sigma_{TH} #times BR_{W'#rightarrow WZ} #times BR_{WZ #rightarrow l#nuqq} , HVT_{B}","L");
