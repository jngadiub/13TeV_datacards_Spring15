...
//=========  (Mon Nov 16 20:09:42 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,13.23017);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,3.825839);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,2.604692);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,1.637392);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,1.161215);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.8169501);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.5383621);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.3255933);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.2933052);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.2339607);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.2136798);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,2.154386);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,2.277337);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,2.702274);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,2.815574);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,4.306826);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,5.846951);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,7.977477);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,10.29194);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,16.1556);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,22.54063);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,62.7319);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,430,4870);
   Graph_Graph1->SetMinimum(0.1923118);
   Graph_Graph1->SetMaximum(68.98372);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,17.87462);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,5.418506);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,3.7416);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,2.369285);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,1.706358);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,1.213008);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.8313697);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.5211356);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.4871637);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.3985717);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.3708502);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,1.407026);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,1.463498);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,1.708301);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,1.735723);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,2.564858);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,3.452094);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,4.727345);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,6.219034);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,9.762223);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,13.83572);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,40.43616);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,430,4870);
   Graph_Graph2->SetMinimum(0.3337652);
   Graph_Graph2->SetMaximum(44.44269);
   ...
   grae->SetPoint(0,800,26.15386);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,8.406994);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,5.8749);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,3.742611);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,2.765312);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,1.982362);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,1.420832);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.9287118);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.8912302);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.7510211);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.7104159);
   grae->SetPointError(10,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,430,4870);
   Graph_Graph3->SetMinimum(0.6393743);
   Graph_Graph3->SetMaximum(28.6982);
