...
//=========  (Sun Nov 22 09:31:36 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,20.91332);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,4.533392);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,3.057682);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,1.935055);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,1.366193);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.9738069);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.6394777);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.3689084);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.3201516);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.2442651);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.2173618);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,2.142721);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,2.29829);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,2.81569);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,3.021549);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,4.840637);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,6.419768);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,8.849346);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,11.70207);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,18.64139);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,26.22908);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,85.33435);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,430,4870);
   Graph_Graph1->SetMinimum(0.1956256);
   Graph_Graph1->SetMaximum(93.84605);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,26.90992);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,6.463017);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,4.407309);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,2.779677);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,1.9916);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,1.426753);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.9649313);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.5773661);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.5174582);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.4108153);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.3731148);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,1.388199);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,1.464939);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,1.75053);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,1.831069);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,2.806721);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,3.855691);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,5.309886);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,7.182875);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,11.35004);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,16.23567);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,56.58649);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,430,4870);
   Graph_Graph2->SetMinimum(0.3358034);
   Graph_Graph2->SetMaximum(62.20783);
   ...
   grae->SetPoint(0,800,37.97029);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,9.961788);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,6.896622);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,4.364529);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,3.165116);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,2.276663);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,1.597134);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.996734);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.9287118);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.7579621);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.7065984);
   grae->SetPointError(10,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,430,4870);
   Graph_Graph3->SetMinimum(0.6359385);
   Graph_Graph3->SetMaximum(41.69666);
