...
//=========  (Mon Nov 16 20:03:32 2015) by ROOT version5.34/18
   ...
   grae->SetPoint(0,800,2.215994);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.3937687);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.2686022);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.1734909);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.1239492);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.09531465);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.05893313);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.04588105);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.03170987);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.03067244);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.02844574);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,0.2915315);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,0.3062408);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,0.3020189);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,0.3797978);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,0.4607504);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,0.6294136);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,0.7764517);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,1.003988);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,1.499286);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,2.173581);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,8.881556);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,430,4870);
   Graph_Graph1->SetMinimum(0.02560117);
   Graph_Graph1->SetMaximum(9.766867);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,800,2.846399);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.5587576);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.3806083);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.2468613);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.1797945);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.1403623);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.08983719);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.07162558);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.05372241);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.05305939);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.04973036);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,4500,0.1903987);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,4000,0.1968013);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,3500,0.192508);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,3000,0.2301588);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2500,0.2719798);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2000,0.380867);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1800,0.4728865);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1600,0.6267113);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1400,0.9364713);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1200,1.370865);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,800,6.006727);
   grae->SetPointError(21,0,0,0,0);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,430,4870);
   Graph_Graph2->SetMinimum(0.04475733);
   Graph_Graph2->SetMaximum(6.602426);
   ...
   grae->SetPoint(0,800,4.009148);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,1200,0.8579131);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1400,0.5802714);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1600,0.3845339);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1800,0.2845828);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,2000,0.2248899);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,2500,0.1520089);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,3000,0.1252859);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,3500,0.09960399);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,4000,0.1009922);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,4500,0.09613347);
   grae->SetPointError(10,0,0,0,0);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,430,4870);
   Graph_Graph3->SetMinimum(0.08652012);
   Graph_Graph3->SetMaximum(4.400449);
